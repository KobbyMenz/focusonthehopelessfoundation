...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="pt-20 min-h-screen bg-gradient-to-br from-background via-secondary to-background world-map-bg flex items-center">
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div 
            ...
            className="text-xl md:text-2xl lg:text-3xl text-primary mb-12 font-medium"
          >
            <div className="typewriter animate-typewriter">
              Filling our world with smiles – fueling the hope every soul deserves.
            </div>
          </motion.div>
          ...
          >
            <img 
              src="https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1200&h=600" 
